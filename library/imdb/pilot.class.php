<?php
 ...
 /* $Id: pilot.class.php 475 2011-10-11 15:00:27Z izzy $ */
  ...
  * @version $Revision: 475 $ $Date: 2011-10-11 17:00:27 +0200 (Di, 11. Okt 2011) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 475 $');
