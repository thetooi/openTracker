<?php
 ...
 /* $Id: imdb_person.class.php 462 2011-08-19 15:53:53Z izzy $ */
  ...
  * @version $Revision: 462 $ $Date: 2011-08-19 17:53:53 +0200 (Fr, 19. Aug 2011) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 462 $');
    $this->setid($id);
  }
